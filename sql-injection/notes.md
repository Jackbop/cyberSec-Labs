...
Procedura
    ...
    Analisi manuale: Ho verificato che aggiungendo ' AND '1'='1 al cookie TrackingId, la pagina mostrava "Welcome back", mentre con ' AND '1'='2 la scritta spariva.
    Automazione con sqlmap: Ho utilizzato il seguente comando per estrarre il database:
